...
def dynamicRouting(switchTable, hostIPTable, linkUtil, dropRate):
    global flag_policy1
    if ((linkUtil < 0.85 and linkUtil > 0) or dropRate > 0.2) and (not flag_policy1):
        print('TRIGGER DYNAMIC ROUTING IN POLICY1. linkUtil={lu}, dropRate={dr}'.format(lu=linkUtil,dr=dropRate))
        s1FlowH1toH4 = {"switch":"00:00:00:00:00:00:00:01","name":"S1h1toh4_policy1","cookie":"0",
                        "priority":"2","in_port":"1","eth_type":"0x800","ipv4_src":"10.0.0.1",
                        "ipv4_dst":"10.0.0.4","active":"true","actions":"output=2"}
        s2FlowH1toH4 = {'switch':"00:00:00:00:00:00:00:02","name":"S2h1toh4_policy1","cookie":"0",
                        "priority":"2","in_port":"2","eth_type":"0x800","ipv4_src":"10.0.0.1",
                        "ipv4_dst":"10.0.0.4","active":"true","actions":"output=3"}
        s3FlowH1toH4 = {'switch':"00:00:00:00:00:00:00:03","name":"S3h1toh4_policy1","cookie":"0",
