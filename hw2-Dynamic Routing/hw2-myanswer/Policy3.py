...
def dynamicRouting(switchTable, hostIPTable, linkUtil, dropRate):
	...
	global flag_policy3
	if ((linkUtil < 0.85 and linkUtil > 0) or dropRate > 0.2) and (not flag_policy3):
		print('TRIGGER DYNAMIC ROUTING IN POLICY3. linkUtil={lu}, dropRate={dr}'.format(lu=linkUtil, dr=dropRate))
		s2FlowH2toH5 = {"switch":"00:00:00:00:00:00:00:02","name":"S2h2toh5_policy3","cookie":"0",
                        "priority":"2","in_port":"1","eth_type":"0x800","ipv4_src":"10.0.0.2",
                        "ipv4_dst":"10.0.0.5","active":"true","actions":"output=2"}
		s1FlowH2toH5 = {"switch":"00:00:00:00:00:00:00:01","name":"S1h2toh5_policy3","cookie":"0",
                        "priority":"2","in_port":"2","eth_type":"0x800","ipv4_src":"10.0.0.2",
                        "ipv4_dst":"10.0.0.5","active":"true","actions":"output=3"}
		s3FlowH2toH5 = {"switch":"00:00:00:00:00:00:00:03","name":"S3h2toh5_policy3","cookie":"0",
                        "priority":"2","in_port":"4","eth_type":"0x800","ipv4_src":"10.0.0.2",
                        "ipv4_dst":"10.0.0.5","active":"true","actions":"output=3"}
	        pusher.set(s2FlowH2toH5)
	        pusher.set(s1FlowH2toH5)
	        pusher.set(s3FlowH2toH5)

	        flag_policy3 = True

if __name__ =='__main__':
	staticForwarding()
	Automonitor.monitor("policy3")